...
void assertNode(const objects::layout::NodeItemSetup& itemSetup, const std::string& name, const std::size_t parentIndex)
{
    assertNode(itemSetup, data_structures::hash::hash(name.c_str()), parentIndex);
}
