...
namespace dory::domain::services
{
    ...
    {
    public:
        void setToIdentity(geometry::Matrix4x4* matrix)
        {
        ...
        void copyEntriesTo(const geometry::Matrix4x4* sourceMatrix, geometry::Matrix4x4* destinationMatrix)
        {
        ...
        void multiply(const geometry::Matrix4x4* matrixLeftSide, const geometry::Matrix4x4* matrixRightSide, geometry::Matrix4x4* resultMatrix)
        {
        ...
        void multiply(const geometry::Matrix4x4* matrix, const geometry::Point3d* vector, geometry::Point3d* resultVector)
        {
        ...
        void multiply(const geometry::Matrix4x4* matrix, const geometry::Point3d* vector, geometry::Point3d* resultVector, float& wResult)
        {
        ...
        void invert(const geometry::Matrix4x4* matrix, geometry::Matrix4x4* resultMatrix)
        {
        ...
        void toIdentity(geometry::Matrix4x4* matrix)
        {
        ...
        void translate(geometry::Matrix4x4* matrix, float dx, float dy, float dz)
        {
            matrix->entries[3] = dx;
            matrix->entries[7] = dy;
        ...
        void scale(geometry::Matrix4x4* matrix, float x, float y, float z)
        {
            matrix->entries[0] = x;
            matrix->entries[5] = y;
            matrix->entries[10] = z;
        ...
        void rotateX(geometry::Matrix4x4* matrix, float radians)
        {
        ...
        void rotateY(geometry::Matrix4x4* matrix, float radians)
        {
        ...
        void rotateZ(geometry::Matrix4x4* matrix, float radians)
        {
            matrix->entries[0] = std::cos(radians);
        ...
        bool isEqual(geometry::Matrix4x4* matrixA, geometry::Matrix4x4* matrixB)
        {
            for(int i = 0; i < geometry::Matrix4x4::size; ++i)
            {
