...
namespace dory::generic::registry
{
    ...
    private:
        ...
        void set_internal(std::size_t index, const extension::LibraryHandle& libraryHandle, const ServicePointerType<BaseInterfaceType>& service)
        {
            _services[index] = extension::ResourceHandle{ libraryHandle, std::static_pointer_cast<BaseInterfaceType>(service) };
        }
    ...
    public:
        ...
        template<typename TServiceInterface>
        void set(const extension::LibraryHandle& libraryHandle, const ServicePointerType<BaseInterfaceType>& service)
        {
        ...
        template<typename TServiceInterface, typename TIdentifier>
        void set(const extension::LibraryHandle& libraryHandle, const ServicePointerType<BaseInterfaceType>& service, TIdentifier&& identifier)
        {
