...
namespace dory::memory::allocators::general_purpose
{
    ...
    class SegregationAllocator: public GeneralAllocator<SegregationAllocator<SizeClassCount, TPageAllocator, TLargeObjectAllocator, TMemoryBlockNodeAllocator, TProfiler>>
    {
    private:
