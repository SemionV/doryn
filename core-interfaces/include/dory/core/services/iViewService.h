...
namespace dory::core::services
{
    ...
    {
    public:
        virtual void updateViews(resources::scene::SceneViewStateSet& viewStates) = 0;
        ...
        virtual void updateViewsState(resources::scene::SceneViewStateSet& states, float alpha) = 0;
    };
}
